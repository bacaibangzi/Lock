...
<body class="fixed-box">
  		...
  		<div id="Js_asideMod" class="fixed-side">
			<iframe id="Js_commTree" name="group_tree" width="100%"
				src="<%=basePath%>yonghu/leftTree.htm?orgCode=${sessionScope.accountInfo.orgCode}" frameborder="0"
		...
		<div id="Js_mainMod" class="fixed-main">
			<iframe name="group_info" width="100%" id="group_info"
				src="<%=basePath%>yonghu/center.htm?code=${sessionScope.accountInfo.orgCode}" frameborder="0"
				bordercolor="blue" scrolling="auto">
			</iframe>
		</div>
		<!--split bar-->
		...
		<script type="text/javascript">
			//alert('${sessionScope.accountInfo.orgCode}');
		</script>
</body>
</html>
