...
<body>
    ...
    <div class="contenbox"> 
    	<div class="grid_summay_opts" id="btns">
				<div class="left_opts">
						<a hideFocus="true" href="javascript:add1('<%=basePath%>org/eidt.htm?code=${vo.code}&code1=${vo.code1}&orgType=${vo.orgType}')" class="gray_radiu_btn" >
							<em class="gray_l"></em> 
							<em class="gray_r"></em> 
							新增
						</a>
	...
	<script type="text/javascript">
		...
		function highQuery()
		{
			...
			var returnVal = '<%=basePath%>org/list.htm?code=0';
			if(areaName_filter!=''){
